...
public class ShopContentProvider extends ContentProvider {
	...
	public static final String CONTENT_ITEM_TYPE = ContentResolver.CURSOR_ITEM_BASE_TYPE
			+ "/choice";
	public static final String CONTENT_TYPE = ContentResolver.CURSOR_DIR_BASE_TYPE + "/choices";
	...
	public int delete(Uri uri, String selection, String[] selectionArgs) {
		...
		case CHOICE_ID:
			...
			if (TextUtils.isEmpty(selection)) {
				rowsAffected = sqlDB.delete(ChoiceTable.TABLE, ChoiceTable.COLUMN_ID + "=" + id,
						null);
			} else {
				rowsAffected = sqlDB.delete(ChoiceTable.TABLE, selection + " and "
						+ ChoiceTable.COLUMN_ID + "=" + id, selectionArgs);
			}
			break;
		default:
	...
	public int update(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
		...
		case CHOICE_ID:
			String id = uri.getLastPathSegment();
			if (TextUtils.isEmpty(selection)) {
				rowsUpdated = sqlDB.update(ChoiceTable.TABLE, values, ChoiceTable.COLUMN_ID + "="
						+ id, null);
			} else {
				rowsUpdated = sqlDB.update(ChoiceTable.TABLE, values, ChoiceTable.COLUMN_ID + "="
